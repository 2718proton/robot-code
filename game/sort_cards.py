...
from robotics_arm.robot_arm_class import RobotArm

# Path to the hand file written by the card reader server
HAND_FILE = os.path.join(ROOT_DIR, 'yolo_card_reader', 'latest_hand.json')
